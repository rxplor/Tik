Public Class A
    ...
    Private Sub Timer1_Tick(sender As Object, e As EventArgs) Handles Timer1.Tick
        ...
        ElseIf lv = 90 Then
            panjang = 27
            target.CharacterCasing = CharacterCasing.Normal
        ElseIf lv = 10 Or lv = 20 Or lv = 30 Or lv = 40 Or lv = 50 Or lv = 60 Or lv = 70 Or lv = 80 Then
            panjang = 15
            target.CharacterCasing = CharacterCasing.Normal
        ElseIf lv >= 91 Then
            panjang = 12
    ...
    Private Sub A_FormClosing(sender As Object, e As FormClosingEventArgs) Handles MyBase.FormClosing
        Timer1.Stop()
        Timer2.Stop()
        Timer3.Stop()
        ...
        Else
            ...
            If e.CloseReason = CloseReason.UserClosing Then
                If lv > 100 Then
                    ...
                    If MsgBox("Anda telah mencapai Level 100." & vbCrLf & vbCrLf & "Anda telah menyelesaikan mode klasik" & vbCrLf & "============================" & vbCrLf & "Klik [ OK ] untuk melihat hasil", MsgBoxStyle.OkOnly, "Pemberitahuan") = MsgBoxResult.Ok Then
                        If lv > 100 Then
                            ...
                            usai.riw.AppendText("Total: " & jhuruf & " karakter diketik dalam waktu " & jtime / 63 & " detik" & Environment.NewLine)
                            usai.riw.AppendText("" & Environment.NewLine)
                            usai.riw.AppendText("Permainan mode klasik selesai pada pukul " & TimeOfDay.ToLongTimeString & ", " & Date.Now.ToShortDateString & Environment.NewLine)
                            e.Cancel = False
                            usai.lv.Text = "[HASIL AKHIR]  Level: " & lv - 1 & ". Skor: " & skor
                            If My.Settings.challenge = False Then
                                base.tantangan = True
                                usai.riw.AppendText("Mode tantangan telah terbuka" & Environment.NewLine)
                            ...
                            'usai.Show()
                        Else
                            usai.riw.AppendText("Mode klasik gagal diselesaikan" & Environment.NewLine)
                            usai.riw.AppendText("" & Environment.NewLine)
                            usai.riw.AppendText("" & Environment.NewLine)
                            usai.riw.AppendText("" & Environment.NewLine)
                            usai.riw.AppendText("Kecepatan mengetik: " & (jhuruf / (jtime / 63)) * 60 & " karakter per menit" & Environment.NewLine)
    ...
    Private Sub Timer4_Tick(sender As Object, e As EventArgs) Handles Timer4.Tick
        ...
        usai.riw.AppendText("Permainan mode klasik dimulai pada pukul " & TimeOfDay.ToLongTimeString & ", " & Date.Now.ToShortDateString & Environment.NewLine)
        usai.riw.AppendText("" & Environment.NewLine)
    ...
    Private Sub A_FormClosed(sender As Object, e As FormClosedEventArgs) Handles MyBase.FormClosed
        If skor > klasik Then
            'skor
            Hi.skor = skor
            'jumlah huruf
